...
(function() {
  ...
  slothdrawin = function() {
    var $canvas, $sizeIndicator, activateButton, bgCanvas, bgCtx, brushSize, brushTimeout, canvas, clickEvent, ctx, dragging, drawAction, drawSloth, drawSlothEvent, erase, eraseEvent, eraseMode, imageLoaded, jump, offset, prev, reset, setBrushImageSize, setBrushSize, setMoonCursor, sloth, slothCount, slothMode, startTime, state, states, touchDevice,
      _this = this;
    ...
    drawSlothEvent = function(e) {
      var point, time, x, y, _i, _len, _ref, _results;
      if (!imageLoaded) {
        return;
      }
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        drawSloth(x, y);
        _results.push(points[time - startTime] = {
          x: x,
          y: y
        });
      }
    ...
    $("body").on('mousewheel DOMMouseScroll', function(e) {
      ...
      if (state === states.SLOTHING) {
        setBrushSize(brushSize, {
          x: _this.cursorPositions[0].x - brushSize / 2,
          y: _this.cursorPositions[0].y
        }, true);
      } else {
